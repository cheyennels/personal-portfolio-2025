      ...
      <Section>
        ...
        <div className="flex flex-col gap-4 lg:max-w-[60%]">
          ...
          <p className="section-body">
            I’m currently designing a mobile app called Puppy Pedometer, created
            to encourage users to get outside and stay active. Drawing
            inspiration from apps like Pikmin Bloom, Finch, and Pokémon Go, the
            app transforms daily steps into growth for a virtual puppy while
            unlocking accessories for customization. I’m in the process of
            wireframing and developing pixel art, with the goal of creating a
            cozy, peaceful, and playful aesthetic.{' '}
          </p>
        </div>
      </Section>
    </div>
